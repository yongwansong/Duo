...
class HeaderDrawer extends MenuDrawer {
  ...
  openMenuDrawer(summaryElement) {
    this.header = this.header || document.querySelector('.endrock-header');
  ...
  renderProductInfo() {
    fetch(`${this.dataset.url}?variant=${this.currentVariant.id}&section_id=${this.dataset.section}`)
      ...
      .then((responseText) => {
        ...
        this.toggleAddButton(!this.currentVariant.available, window.variantStrings.soldOut, true, addToCartText);
      });
  }

  toggleAddButton(disable = true, text, modifyClass = true, addToCartText) {
    ...
    if (disable) {
      ...
      addButtonText.textContent = addToCartText || window.variantStrings.addToCart;
    }
